...
beats_analysis_window = 800 # how many edges to accumulate before doing weeding false positives
...
#            print(f"Chunk {i} Edge times: {chunk_edge_times}") 
        ...
        if new_data >= beats_analysis_window:
            ...
            good_beats, bad_beats = detector.weed_beats_from_edges(edges_to_weed, plot_histograms, clock_name)
